    ...
    public class ModMenuIntegration : MonoBehaviour
    {
        ...
        void InitConfig()
        {
            ...
            */
            ...
            AddToWriteQueue("(bool)invisibileBall", "true");
            AddToWriteQueue("(bool)invisibilePlayer", "false");
            AddToWriteQueue("(bool)invisibileOpponents", "false");
            AddToWriteQueue("(header)effectHeader", "Effect Options");
            AddToWriteQueue("(bool)BallEffects", "false");
            AddToWriteQueue("(bool)SuperEffects", "true");
            AddToWriteQueue("(bool)PlayerImpactEffects", "true");
            AddToWriteQueue("(bool)PlayerHitEffects", "true");
        ...
        /// <summary>
        /// Adds Keys, Options or Mod info to the Mod Setting Menu
        /// </summary>
